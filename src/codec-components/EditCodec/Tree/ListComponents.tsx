...
> = ({
  ...
  return (
    <div
      ...
      className={twMerge(
        "hover:bg-secondary/80 border-l border-border last:border-0 last:before:block last:before:absolute last:before:border-l last:before:h-4 last:before:border-border",
